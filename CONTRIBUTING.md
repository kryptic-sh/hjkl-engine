# Contributing to `hjkl-engine`

Thanks for considering a contribution. `hjkl-engine` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/hjkl-engine.git
cd hjkl-engine
